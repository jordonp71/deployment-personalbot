// Enhanced Chat Widget Script with Better Bot Response Formatting
(function() {
    ...
    const styles = `
        ...
        /* Enhanced Typing Animation - like iMessage/WhatsApp */
        .n8n-chat-widget .typing-indicator {
            ...
            animation: typing-fade-in 0.3s ease-in;
        }
        ...
        /* Alternative bubble-style typing animation */
        .n8n-chat-widget .typing-bubble {
            display: flex;
            align-items: center;
            padding: 12px 16px;
            margin: 8px 0;
        ...
        .n8n-chat-widget .typing-bubble-dots {
            display: flex;
            align-items: center;
            gap: 3px;
        }

        .n8n-chat-widget .typing-bubble-dot {
            width: 6px;
            height: 6px;
            border-radius: 50%;
            background: #999;
        ...
        .n8n-chat-widget .typing-bubble-dot:nth-child(1) { animation-delay: 0s; }
        .n8n-chat-widget .typing-bubble-dot:nth-child(2) { animation-delay: 0.15s; }
        .n8n-chat-widget .typing-bubble-dot:nth-child(3) { animation-delay: 0.3s; }
    ...
    function formatMessage(text) {
        ...
        if (!text.startsWith('<p>') && !text.includes('<ul>')) {
            text = `<p>${text}</p>`;
    ...
    function showTypingIndicator() {
        ...
        typingIndicator.innerHTML = `
            ...
            <span style="margin-left: 8px; font-size: 13px; opacity: 0.7;">AI is typing...</span>
        `;
    ...
    async function startNewConversation() {
        ...
        try {
            ...
            errorMessageDiv.innerHTML = '<p><em>Sorry, I encountered an error. Please try again.</em></p>';
